...
class NewSongEntity {
  ...
  NewSongEntity.fromJson(Map<String, dynamic> json) {
    if (json['result'] != null) {
      result = new List<NewSongResult>();
      (json['result'] as List).forEach((v) {
        result.add(new NewSongResult.fromJson(v));
      });
    }
    code = json['code'];
...
class NewSongResultSong {
  ...
  NewSongResultSong.fromJson(Map<String, dynamic> json) {
    ...
    privilege = json['privilege'] != null
        ? new NewSongResultSongPrivilege.fromJson(json['privilege'])
        : null;
    mMusic = json['mMusic'] != null
        ? new NewSongResultSongMmusic.fromJson(json['mMusic'])
        : null;
    bMusic = json['bMusic'] != null
        ? new NewSongResultSongBmusic.fromJson(json['bMusic'])
        : null;
    ...
    if (json['artists'] != null) {
      artists = new List<NewSongResultSongArtist>();
      (json['artists'] as List).forEach((v) {
        artists.add(new NewSongResultSongArtist.fromJson(v));
      });
    }
    if (json['rtUrls'] != null) {
    ...
    album = json['album'] != null
        ? new NewSongResultSongAlbum.fromJson(json['album'])
        : null;
    lMusic = json['lMusic'] != null
        ? new NewSongResultSongLmusic.fromJson(json['lMusic'])
        : null;
    ...
    hMusic = json['hMusic'] != null
        ? new NewSongResultSongHmusic.fromJson(json['hMusic'])
        : null;
    mvid = json['mvid'];
    name = json['name'];
    disc = json['disc'];
...
class NewSongResultSongAlbum {
  ...
  NewSongResultSongAlbum.fromJson(Map<String, dynamic> json) {
    artist = json['artist'] != null
        ? new NewSongResultSongAlbumArtist.fromJson(json['artist'])
        : null;
    ...
    briefDesc = json['briefDesc'];
    if (json['artists'] != null) {
      artists = new List<NewSongResultSongAlbumArtist>();
      (json['artists'] as List).forEach((v) {
        artists.add(new NewSongResultSongAlbumArtist.fromJson(v));
      });
    }
    if (json['alias'] != null) {
      alias = new List<Null>();
