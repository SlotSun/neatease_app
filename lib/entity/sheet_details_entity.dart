class SheetDetailsEntity {
  ...
  SheetDetailsEntity.fromJson(Map<String, dynamic> json) {
    if (json['privileges'] != null) {
      privileges = new List<SheetDetailsPrivilege>();
      (json['privileges'] as List).forEach((v) {
        privileges.add(new SheetDetailsPrivilege.fromJson(v));
      });
    }
    code = json['code'];
    playlist = json['playlist'] != null
        ? new SheetDetailsPlaylist.fromJson(json['playlist'])
        : null;
  }
...
class SheetDetailsPlaylist {
  ...
  SheetDetailsPlaylist.fromJson(Map<String, dynamic> json) {
    ...
    if (json['trackIds'] != null) {
      trackIds = new List<SheetDetailsPlaylistTrackid>();
      (json['trackIds'] as List).forEach((v) {
        trackIds.add(new SheetDetailsPlaylistTrackid.fromJson(v));
      });
    }
    id = json['id'];
    ordered = json['ordered'];
    creator = json['creator'] != null
        ? new SheetDetailsPlaylistCreator.fromJson(json['creator'])
        : null;
    if (json['subscribers'] != null) {
      subscribers = new List<SheetDetailsPlaylistSubscriber>();
      (json['subscribers'] as List).forEach((v) {
        subscribers.add(new SheetDetailsPlaylistSubscriber.fromJson(v));
      });
    }
    ...
    userId = json['userId'];
    if (json['tracks'] != null) {
      tracks = new List<SheetDetailsPlaylistTrack>();
      (json['tracks'] as List).forEach((v) {
        tracks.add(new SheetDetailsPlaylistTrack.fromJson(v));
      });
    }
...
class SheetDetailsPlaylistSubscriber {
  ...
  SheetDetailsPlaylistSubscriber(
      {this.birthday,
      this.detailDescription,
      this.backgroundUrl,
      this.gender,
...
class SheetDetailsPlaylistTrack {
  ...
  SheetDetailsPlaylistTrack.fromJson(Map<String, dynamic> json) {
    ...
    cf = json['cf'];
    h = json['h'] != null
        ? new SheetDetailsPlaylistTracksH.fromJson(json['h'])
        : null;
    mv = json['mv'];
    al = json['al'] != null
    ...
    l = json['l'] != null
        ...
        : null;
    m = json['m'] != null
        ? new SheetDetailsPlaylistTracksM.fromJson(json['m'])
        : null;
    cp = json['cp'];
