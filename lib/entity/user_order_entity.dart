...
class UserOrderEntity {
	num code;
	List<SheetDetailsPlaylist> playlist;
	bool more;
	...
	UserOrderEntity.fromJson(Map<String, dynamic> json) {
		...
		if (json['playlist'] != null) {
			playlist = new List<SheetDetailsPlaylist>();(json['playlist'] as List).forEach((v) { playlist.add(new SheetDetailsPlaylist.fromJson(v)); });
		}
		more = json['more'];
	}
