...
class TodaySongEntity {
  ...
  TodaySongEntity.fromJson(Map<String, dynamic> json) {
    ...
    if (json['recommend'] != null) {
      recommend = new List<TodaySongRecommand>();
      (json['recommend'] as List).forEach((v) {
        recommend.add(new TodaySongRecommand.fromJson(v));
      });
    }
  }
...
class TodaySongRecommand {
  ...
  num rtype;
  bool starred;
  List<SheetDetailsPlaylistTracksAr> artists;
  List<Null> rtUrls;
  num popularity;
  num playedNum;
  num hearTime;
  ...
  dynamic audition;
  dynamic transName;
  SheetDetailsPlaylistTracksAl album;
  ...
  TodaySongRecommand.fromJson(Map<String, dynamic> json) {
    ...
    privilege = json['privilege'] != null
        ? new TodaySongRecommendPrivilege.fromJson(json['privilege'])
        : null;
    mMusic = json['mMusic'] != null
        ? new TodaySongRecommendMmusic.fromJson(json['mMusic'])
        : null;
    bMusic = json['bMusic'] != null
        ? new TodaySongRecommendBmusic.fromJson(json['bMusic'])
        : null;
    ...
    if (json['artists'] != null) {
      artists = new List<SheetDetailsPlaylistTracksAr>();
      (json['artists'] as List).forEach((v) {
        artists.add(new SheetDetailsPlaylistTracksAr.fromJson(v));
      });
    }
    if (json['rtUrls'] != null) {
    ...
    lMusic = json['lMusic'] != null
        ? new TodaySongRecommendLmusic.fromJson(json['lMusic'])
        : null;
    ...
    hMusic = json['hMusic'] != null
        ? new TodaySongRecommendHmusic.fromJson(json['hMusic'])
        : null;
    mvid = json['mvid'];
    name = json['name'];
    disc = json['disc'];
...
class TodaySongRecommendAlbum {
  ...
  TodaySongRecommendAlbum.fromJson(Map<String, dynamic> json) {
    artist = json['artist'] != null
        ? new TodaySongRecommendAlbumArtist.fromJson(json['artist'])
        : null;
    ...
    briefDesc = json['briefDesc'];
    if (json['artists'] != null) {
      artists = new List<TodaySongRecommandAlbumArtists>();
      (json['artists'] as List).forEach((v) {
        artists.add(new TodaySongRecommandAlbumArtists.fromJson(v));
      });
    }
    if (json['alias'] != null) {
      alias = new List<Null>();
...
class TodaySongRecommandAlbumArtists {
  ...
  TodaySongRecommandAlbumArtists(
      {this.picUrl,
      this.img1v1Url,
      this.topicPerson,
      this.briefDesc,
