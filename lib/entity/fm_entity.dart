...
class FmEntity {
  num code;
  List<SheetDetailsPlaylistTrack> data;
  bool popAdjust;
  ...
  FmEntity.fromJson(Map<String, dynamic> json) {
    code = json['code'];
    if (json['data'] != null) {
      data = new List<SheetDetailsPlaylistTrack>();
      (json['data'] as List).forEach((v) {
        data.add(new SheetDetailsPlaylistTrack.fromJson(v));
      });
    }
...
class FmData {
  ...
  FmData.fromJson(Map<String, dynamic> json) {
    ...
    privilege = json['privilege'] != null
        ? new FmDataPrivilege.fromJson(json['privilege'])
        : null;
    mMusic = json['mMusic'] != null
        ? new FmDataMmusic.fromJson(json['mMusic'])
        : null;
    bMusic = json['bMusic'] != null
        ? new FmDataBmusic.fromJson(json['bMusic'])
        : null;
    ...
    if (json['artists'] != null) {
      artists = new List<FmDataArtist>();
      (json['artists'] as List).forEach((v) {
        artists.add(new FmDataArtist.fromJson(v));
      });
    }
    if (json['rtUrls'] != null) {
    ...
    album =
        json['album'] != null ? new FmDataAlbum.fromJson(json['album']) : null;
    lMusic = json['lMusic'] != null
        ? new FmDataLmusic.fromJson(json['lMusic'])
        : null;
    ...
    hMusic = json['hMusic'] != null
        ? new FmDataHmusic.fromJson(json['hMusic'])
        : null;
    mvid = json['mvid'];
    name = json['name'];
    disc = json['disc'];
...
class FmDataAlbum {
  ...
  FmDataAlbum.fromJson(Map<String, dynamic> json) {
    ...
    artist = json['artist'] != null
        ? new FmDataAlbumArtist.fromJson(json['artist'])
        : null;
    ...
    copyrightId = json['copyrightId'];
    if (json['artists'] != null) {
      artists = new List<FmDataAlbumArtist>();
      (json['artists'] as List).forEach((v) {
        artists.add(new FmDataAlbumArtist.fromJson(v));
      });
    }
    if (json['songs'] != null) {
      songs = new List<Null>();
