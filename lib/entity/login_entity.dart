class LoginEntity {
  ...
  LoginEntity(
      {this.code, this.lognumype, this.profile, this.bindings, this.account});

  LoginEntity.fromJson(Map<String, dynamic> json) {
    code = json['code'];
    lognumype = json['lognumype'];
    profile = json['profile'] != null
        ? new LoginProfile.fromJson(json['profile'])
        : null;
    if (json['bindings'] != null) {
      bindings = new List<LoginBinding>();
      (json['bindings'] as List).forEach((v) {
        bindings.add(new LoginBinding.fromJson(v));
      });
    }
    account = json['account'] != null
        ? new LoginAccount.fromJson(json['account'])
        : null;
  }
...
class LoginProfile {
  ...
  LoginProfile.fromJson(Map<String, dynamic> json) {
    ...
    experts = json['experts'] != null
        ? new LoginProfileExperts.fromJson(json['experts'])
        : null;
