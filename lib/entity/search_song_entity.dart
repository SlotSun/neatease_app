...
class SearchSongEntity {
  ...
  SearchSongEntity.fromJson(Map<String, dynamic> json) {
    result = json['result'] != null
        ? new SearchSongResult.fromJson(json['result'])
        : null;
    code = json['code'];
  }
...
class SearchSongResultSong {
  ...
  SearchSongResultSong.fromJson(Map<String, dynamic> json) {
    album = json['album'] != null
        ? new SearchSongResultSongsAlbum.fromJson(json['album'])
        : null;
    fee = json['fee'];
    rUrl = json['rUrl'];
    ...
    if (json['artists'] != null) {
      ...
      (json['artists'] as List).forEach((v) {
        artists.add(new SearchSongResultSongsArtist.fromJson(v));
      });
    }
...
class SearchSongResultSongsAlbum {
  ...
  SearchSongResultSongsAlbum.fromJson(Map<String, dynamic> json) {
    ...
    artist = json['artist'] != null
        ? new SearchSongResultSongsAlbumArtist.fromJson(json['artist'])
        : null;
    copyrightId = json['copyrightId'];
    name = json['name'];
    id = json['id'];
...
class SearchSongResultSongsAlbumArtist {
  ...
  SearchSongResultSongsAlbumArtist(
      {this.picUrl,
      this.img1v1Url,
      this.img1v1,
      this.name,
